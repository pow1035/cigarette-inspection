...
int     MyCamera::GetAllMatchInfo(IN void* hDevHandle, IN unsigned int nTLayerType, OUT unsigned int* nLostFrame, OUT unsigned int* nFrameCount)
{
    int nRet = MV_OK;
    ...
    else if (MV_USB_DEVICE == nTLayerType)
    {
        ...
        //*nFrameCount = pInfo->nReceivedFrameCount;
